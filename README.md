...
- Python 3
- [NetBird](https://netbird.io) installed and connected
- **Verified working on:** macOS 26.5.2, Apple M5 (MacBook Air). Other
  Apple Silicon Macs and recent macOS versions are likely fine too, but
  untested.
